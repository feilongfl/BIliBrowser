class EposideInfo {
  ...
  EposideInfo.fromJson(Map<String, dynamic> json) {
    ...
    userstate = json['userState'] != null
        ? new EposideInfoUserstate.fromJson(json['userState'])
        : null;
    if (json['ssList'] != null) {
    ...
    mediainfo = json['mediaInfo'] != null
        ? new EposideInfoMediainfo.fromJson(json['mediaInfo'])
        : null;
...
class EposideInfoMediainfo {
  ...
  EposideInfoMediainfo.fromJson(Map<String, dynamic> json) {
    ...
    activity = json['activity'] != null
        ? new EposideInfoMediainfoActivity.fromJson(json['activity'])
        : null;
    sstypeformat = json['ssTypeFormat'] != null
        ? new EposideInfoMediainfoSstypeformat.fromJson(json['ssTypeFormat'])
        : null;
    rating = json['rating'] != null
        ? new EposideInfoMediainfoRating.fromJson(json['rating'])
        : null;
    mainsectitle = json['mainSecTitle'];
    title = json['title'];
    cover = json['cover'];
    right = json['rights'] != null
        ? new EposideInfoMediainfoRight.fromJson(json['rights'])
        : null;
    alia = json['alias'];
    id = json['id'];
    upinfo = json['upInfo'] != null
        ? new EposideInfoMediainfoUpinfo.fromJson(json['upInfo'])
        : null;
    newestep = json['newestEp'] != null
        ? new EposideInfoMediainfoNewestep.fromJson(json['newestEp'])
        : null;
    squarecover = json['squareCover'];
    count = json['count'] != null
        ? new EposideInfoMediainfoCount.fromJson(json['count'])
        : null;
    epspmode = json['epSpMode'];
    paymant = json['payMent'] != null
        ? new EposideInfoMediainfoPaymant.fromJson(json['payMent'])
        : null;
    specialcover = json['specialCover'];
    ssid = json['ssId'];
    paypack = json['payPack'] != null
        ? new EposideInfoMediainfoPaypack.fromJson(json['payPack'])
        : null;
...
class EposideInfoMediainfoPaymant {
  ...
  EposideInfoMediainfoPaymant.fromJson(Map<String, dynamic> json) {
    sixtype = json['sixType'] != null
        ? new EposideInfoMediainfoPaymantSixtype.fromJson(json['sixType'])
        : null;
