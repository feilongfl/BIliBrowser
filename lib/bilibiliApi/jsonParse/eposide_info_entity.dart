...
//	EposideInfoLogininfo logininfo;
  ...
  EposideInfo(
      {this.sponsor, this.ver, this.sslist, this.sspaymant, this.eplist, this.section, this.loaded, this.eppaymant, this.ssrecom, this.ssr, this.userstate, this.logininfo, this.insertscript, this.h1title, this.mediainfo, this.epinfo, this.player});

  EposideInfo.fromJson(Map<String, dynamic> json) {
    sponsor = json['sponsor'] != null
        ? new EposideInfoSponsor.fromJson(json['sponsor'])
        : null;
    ver = json['ver'] != null ? new EposideInfoVer.fromJson(json['ver']) : null;
    if (json['ssList'] != null) {
    ...
    if (json['sections'] != null) {
      section = new List<Null>();
      json['sections'].forEach((v) {
        section.add(new Null.fromJson(v));
      });
    }
    loaded = json['loaded'];
//		eppaymant = json['epPayMent'];
//		if (json['ssRecom'] != null) {
//			ssrecom = new List<Null>();
//			json['ssRecom'].forEach((v) { ssrecom.add(new Null.fromJson(v)); });
//		}
//		ssr = json['ssr'] != null ? new EposideInfoSsr.fromJson(json['ssr']) : null;
    userstate = json['userState'] != null ? new EposideInfoUserstate.fromJson(
        json['userState']) : null;
//		logininfo = json['loginInfo'] != null ? new EposideInfoLogininfo.fromJson(json['loginInfo']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.section != null) {
      data['sections'] = this.section.map((v) => v.toJson()).toList();
    }
    data['loaded'] = this.loaded;
//		data['epPayMent'] = this.eppaymant;
//		if (this.ssrecom != null) {
//      data['ssRecom'] = this.ssrecom.map((v) => v.toJson()).toList();
//    }
//		if (this.ssr != null) {
...
class EposideInfoSponsor {
  ...
  EposideInfoSponsor(
      {this.allready, this.weekmine, this.weekrank, this.allstate, this.weekstate, this.allmine, this.weekready, this.allcount, this.allrank, this.weekcount});

  EposideInfoSponsor.fromJson(Map<String, dynamic> json) {
    allready = json['allReady'];
    weekmine = json['weekMine'];
    if (json['weekRank'] != null) {
      weekrank = new List<Null>();
      json['weekRank'].forEach((v) {
        weekrank.add(new Null.fromJson(v));
      });
    }
    ...
    if (json['allRank'] != null) {
      allrank = new List<Null>();
      json['allRank'].forEach((v) {
        allrank.add(new Null.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.weekrank != null) {
      data['weekRank'] = this.weekrank.map((v) => v.toJson()).toList();
    }
    ...
    if (this.allrank != null) {
      data['allRank'] = this.allrank.map((v) => v.toJson()).toList();
    }
...
class EposideInfoUserstate {
  bool loaded;
  EposideInfoUserstateVipinfo vipinfo;

  EposideInfoUserstate({this.loaded, this.vipinfo});

  EposideInfoUserstate.fromJson(Map<String, dynamic> json) {
    loaded = json['loaded'];
    vipinfo =
    json['vipInfo'] != null ? new EposideInfoUserstateVipinfo.fromJson(
        json['vipInfo']) : null;
  }
...
class EposideInfoUserstateVipinfo {


  EposideInfoUserstateVipinfo
...
EposideInfoUserstateVipinfo.fromJson(
...
class EposideInfoLogininfo {


  EposideInfoLogininfo
