...
class AttentionData {
	...
	AttentionData(
			{this.archiveUpNum, this.cards, this.extraFlag, this.newNum, this.openRcmd, this.attentions, this.existGap, this.upNum, this.foldMgr, this.iGt});
	...
	AttentionData.fromJson(Map<String, dynamic> json) {
		...
		extraFlag =
		json['extra_flag'] != null ? new AttentionDataExtraFlag.fromJson(
				json['extra_flag']) : null;
		newNum = json['new_num'];
		openRcmd = json['open_rcmd'];
		attentions =
		json['attentions'] != null ? new AttentionDataAttentions.fromJson(
				json['attentions']) : null;
...
class AttentionDataCard {
	...
	AttentionDataCard.fromJson(Map<String, dynamic> json) {
		...
		extension =
		json['extension'] != null ? new AttentionDataCardsExtension.fromJson(
				json['extension']) : null;
		card = json['card'];
		desc = json['desc'] != null
...
class AttentionDataCardsExtension {
	...
	AttentionDataCardsExtension.fromJson(Map<String, dynamic> json) {
		voteCfg =
		json['vote_cfg'] != null ? new AttentionDataCardsExtensionVoteCfg.fromJson(
				json['vote_cfg']) : null;
		vote = json['vote'];
	}
...
class AttentionDataCardsDesc {
	...
	AttentionDataCardsDesc(
			{this.origDyId, this.like, this.stype, this.innerId, this.dynamicId, this.preDyId, this.acl, this.userProfile, this.type, this.rid, this.origType, this.dynamicIdStr, this.uid, this.view, this.rType, this.repost, this.isLiked, this.timestamp, this.status});
	...
	AttentionDataCardsDesc.fromJson(Map<String, dynamic> json) {
		...
		acl = json['acl'];
		userProfile =
		json['user_profile'] != null ? new AttentionDataCardsDescUserProfile
				.fromJson(json['user_profile']) : null;
		type = json['type'];
		rid = json['rid'];
...
class AttentionDataCardsDescUserProfile {
	...
	AttentionDataCardsDescUserProfile.fromJson(Map<String, dynamic> json) {
		vip =
		json['vip'] != null ? new AttentionDataCardsDescUserProfileVip.fromJson(
				json['vip']) : null;
		pendant =
		json['pendant'] != null ? new AttentionDataCardsDescUserProfilePendant
				.fromJson(json['pendant']) : null;
		card =
		json['card'] != null ? new AttentionDataCardsDescUserProfileCard.fromJson(
				json['card']) : null;
		info =
		json['info'] != null ? new AttentionDataCardsDescUserProfileInfo.fromJson(
				json['info']) : null;
	}
...
class AttentionDataCardsDescUserProfileVip {
	...
	AttentionDataCardsDescUserProfileVip(
			{this.vipduedate, this.viptype, this.accessstatus, this.vipstatus, this.dueremark, this.vipstatuswarn});
