...
class Result {
	...
	Result({this.area, this.arealimit, this.attention, this.bangumiId, this.bgmcount, this.cover, this.danmakuCount, this.epId, this.favorites, this.isFinish, this.lastupdate, this.lastupdateAt, this.new, this.playCount, this.pubTime, this.seasonId, this.seasonStatus, this.spid, this.squareCover, this.title, this.viewrank, this.weekday});
